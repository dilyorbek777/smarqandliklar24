    ...
    return (
        <div
            ...
            <div className="px-[34px] py-7 flex justify-between items-center bg-[#EFBA542E] rounded-md">
                ...
                <button className='bg-gradient-to-r from-[#FE5C28] to-[#ff8b36] px-4 py-2 rounded-md text-[#FFFFFF] font-medium'>Включит  уведомления!</button>
            </div>
        </div>
    )
}
